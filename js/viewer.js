...
function webViewerInitialized() {
  ...
  /*+++*/fileInput.className += ' custom--fileInput';
...
var PDFPageView = function () {
  ...
  _createClass(PDFPageView, [{
    ...
    value: function draw() {
      ...
      // esignCursorWrapper.style.width = div.style.width;
      // esignCursorWrapper.style.height = div.style.height;
      // esignCursorWrapper.classList.add('esignCursorWrapper');
      // canvasWrapper.appendChild(esignCursorWrapper);
      /*+++*/
  ...
  _createClass(Toolbar, [{
    ...
    value: function _updateUIState() {
      ...
      this.l10n.get('page_scale_percent', { scale: customScale }, '{{scale}}%').then(function (msg) {
        ...
        /*+++ Display all esign placeholders
        try {
          var imgPreviewContainer = document.getElementsByClassName("image-previewer")[0];
          var isEsignPickerMode = imgPreviewContainer.classList.contains('esignMarkerMode');
          if(isEsignPickerMode && typeof documentManager !== "undefined") {
            var previewModalId = document.getElementById("preview-modal").getAttribute("data-preview");
            var currentDocument = documentManager.getInstance().documents.get(previewModalId);
            if(currentDocument && currentDocument.esignCoordinates && currentDocument.esignCoordinates.size) {
              console.log(currentDocument.esignCoordinates)
              var markedPage = document.querySelectorAll('.page[data-page-number="1"]');
              if(markedPage.length) {
                var esignPlaceholder = new Image();
                esignPlaceholder.classList.add("marked-esign-placeholder");
                esignPlaceholder.setAttribute("src", "data:image/svg+xml;base64,");
                var esignCoordinates = Array.from(currentDocument.esignCoordinates, function (v, i) {
                    return {
                      width:v[1].width,
                      height: v[1].height,
                      page: v[1].page,
                ...
                esignPlaceholder.style.width = esignCoordinates[0].width;
                esignPlaceholder.style.height = esignCoordinates[0].height;

                markedPage[0].getElementsByClassName("esignCursorWrapper")[0].appendChild(esignPlaceholder);
                $(esignPlaceholder).draggable();
              }
            }
          }
        } catch (error) {
